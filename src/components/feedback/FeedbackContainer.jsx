...
const FeedbackContainer = () => {
  ...
  return (
    <section className="flex flex-col lg:flex-row ">
      ...
      <div className="grid gap-5 md:grid-cols-2 order-2 mt-10  lg:order-1 lg:w-3/5  lg:flex lg:flex-wrap  lg:gap-10">
        {/* <div className='flex gap-2'> */}
        <FeedbackCard className="shadow-custom lg:relative lg:top-28 lg:w-7/12 " />
        <FeedbackCard className=" shadow-custom lg:w-3/12 " />
        {/* </div> */}
        <div className="hidden lg:block lg:relative lg:w-7/12 lg:top-28 ">
